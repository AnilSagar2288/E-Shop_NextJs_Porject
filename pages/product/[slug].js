...
export default function ProductScreen (props) {
  ...
  //   const product = data.products.find (a => a.slug === slug); This one is for static data
  if (!product) {
  ...
  const addToCartHandler = async () =>{
    ...
    if(data.countInStock < quantity && typeof window !== 'undefined'){
      ...
      <Grid container spacing={1}>
        ...
        <Grid item md={3} xs={12}>
          <List>
            ...
            <ListItem><Typography>Barnd: {product.brand}</Typography></ListItem>
            <ListItem>
              <Typography>
